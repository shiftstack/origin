...
replace (
	...
	k8s.io/api => github.com/openshift/kubernetes/staging/src/k8s.io/api v0.0.0-20210624185839-c6914a80ec2e
	...
	k8s.io/cli-runtime => github.com/openshift/kubernetes/staging/src/k8s.io/cli-runtime v0.0.0-20210624185839-c6914a80ec2e
	...
	k8s.io/component-base => github.com/openshift/kubernetes/staging/src/k8s.io/component-base v0.0.0-20210624185839-c6914a80ec2e
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v1.21.2-0.20210624185839-c6914a80ec2e
